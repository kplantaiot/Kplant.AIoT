...
1.  [ ] **Estabilizar Estado del Dispositivo:** El estado `KPCL0037` en el tópico `STATUS` alterna entre "Online" y "Offline" incorrectamente. Se debe investigar y corregir la lógica para que refleje el estado real de la conexión de manera consistente.
