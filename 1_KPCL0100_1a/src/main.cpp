...
void publishDeviceStatus() {
    ...
    doc["KPCL0033"] = device_status_str; // Directly use the device ID as string literal
...
void setup() {
  ...
  // 3. Iniciar el gestor de MQTT (carga certificados, etc.)
  mqttManagerInit();
