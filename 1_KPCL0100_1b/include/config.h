...
// Pines ESP32-CAM (Asignación corregida para evitar conflictos con la cámara)
#define PIN_LED        33 // LED rojo de estado
#define PIN_DHT        14 // Sin cambios, pin seguro
#define PIN_HX711_DOUT 1  // Usando TX0. El monitor serie se deshabilitará para logs.
#define PIN_HX711_SCK  3  // Usando RX0. El monitor serie se deshabilitará para logs.
#define PIN_LDR        2  // ADC2_CH2. Posible conflicto con WiFi, leer con cuidado.
...
#define TOPIC_IMAGE    DEVICE_ID "/IMAGE"
...
#define ADC_MAX_VALUE   4095.0f   // Valor máximo del ADC en ESP32 (12-bit)
