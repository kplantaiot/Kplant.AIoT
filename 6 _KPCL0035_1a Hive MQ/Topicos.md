...
Este documento detalla los tópicos MQTT utilizados por el dispositivo `KPCL0035`, incluyendo su función, estructura de payload y ejemplos.
...
*   **Payload (JSON):**
    ```json
    {
        ...
        "KPCL0035": "Online" | "Offline",
        "sensor_health": "OK" | "ERR_HX711" | "ERR_DHT" | "Initializing"
    }
    ```
*   **Ejemplo:**
    ```json
    {"wifi_status":"Conectado","KPCL0035":"Online","sensor_health":"OK"}
    ```
*   **Consideraciones:**
    *   El campo `KPCL0035` (que representa el `DEVICE_ID`) indica si el dispositivo está "Online" o "Offline" según la lógica de `main.cpp`.
